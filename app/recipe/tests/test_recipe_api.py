...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrive_recipes(self):
        """Test retrrieving s list of recipes."""
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('2.50'),
            'ingredients': [{'name': 'Water'}, {'name': 'Wine'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        ingredient_indian = Ingredient.objects.create(user=self.user, name='Carry')
        payload = {
            'title': 'Pongal',
            'time_minutes': 60,
            'price': Decimal('4.50'),
            'ingredients': [{'name': 'Carry'}, {'name': 'Meat'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient_lunch = Ingredient.objects.create(user=self.user, name='Bread')
